...
var Tab = function (_Component) {
  ...
  Tab.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        attributes = _objectWithoutProperties(_props2, ['children', 'className', 'disabled', 'disabledClassName', 'focus', 'id', 'panelId', 'selected', 'selectedClassName', 'tabRef', 'connectDragSource', 'connectDropTarget', 'isDragging', 'tabKey']);
...
var tabSource = {
  ...
  endDrag: function endDrag(_props, monitor, component) {
    var props = component.decoratedComponentInstance.props;
