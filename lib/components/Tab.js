...
var Tab = function (_Component) {
  ...
  Tab.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        hover = _props2.hover,
        attributes = _objectWithoutProperties(_props2, ['children', 'className', 'disabled', 'disabledClassName', 'focus', 'id', 'panelId', 'selected', 'selectedClassName', 'tabRef', 'connectDragSource', 'connectDropTarget', 'isDragging', 'tabKey', 'endDrag', 'hover']);
