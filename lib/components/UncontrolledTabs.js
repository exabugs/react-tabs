...
var UncontrolledTabs = function (_Component) {
  ...
  UncontrolledTabs.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        attributes = _objectWithoutProperties(_props2, ['children', 'className', 'disabledTabClassName', 'focus', 'forceRenderTabPanel', 'onSelect', 'selectedIndex', 'selectedTabClassName', 'selectedTabPanelClassName', 'connectDropTarget', 'isOver', 'canDrop']);
