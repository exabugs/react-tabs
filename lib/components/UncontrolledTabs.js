...
var UncontrolledTabs = function (_Component) {
  ...
  UncontrolledTabs.prototype.renderOverlay = function renderOverlay(color) {
  ...
  UncontrolledTabs.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        tabsKey = _props2.tabsKey,
        drop = _props2.drop,
        attributes = _objectWithoutProperties(_props2, ['children', 'className', 'disabledTabClassName', 'focus', 'forceRenderTabPanel', 'onSelect', 'selectedIndex', 'selectedTabClassName', 'selectedTabPanelClassName', 'connectDropTarget', 'isOver', 'canDrop', 'tabsKey', 'drop']);
...
var tabTarget = {
  drop: function drop(props, monitor) {
    var tabKey = monitor.getItem().props.tabKey;

    props.drop && props.drop(props.tabsKey, tabKey);
  }
};

UncontrolledTabs = (0, _reactDnd.DropTarget)(_ItemTypes2.default.TAB, tabTarget, function (connect, monitor) {
  return {
